...
public class Task {
    private static final int filds_number = 6;
    ...
    public static void main(String[] args) {
        ...
        if (fields.length != filds_number){
            System.err.println("Неверное количество полей, вы ввели "
                    + fields.length + ", введите 6 полей!");
        }
